    ...
    <form method="POST" action="{{ route('model.update') }}" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="model" id="name" value="{{ $item->model }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Модель" required="">
            </div>
...
{{--                    </div>--}}
                    <input id="dropzone-file-edit-model" type="file" class="" name="photo" />
{{--                </label>--}}
{{--            </div>--}}
            <div>
